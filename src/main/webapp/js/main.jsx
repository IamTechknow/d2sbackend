...
var MainData = (props) => {
    var baseAttr = ClassData[props.data.classNum].attributes;
    var stat = ["Strength", "Dexterity", "Vitality", "Energy"];
    var stat2 = ["str", "dex", "vit", "nrg"];
    return (
        <div id="main">
            <div className="form-row">
                <div className="form-group col-md-6">
                    <label htmlFor="name">Character Name</label>
                    <input type="text" className="form-control" id="name" name="name" placeholder="Up to 15 characters, no numbers" maxLength="15" value={props.data.name} onChange={props.handler}></input>
                </div>

                <div className="form-group col-md-6">
                    <label htmlFor="level">Character Level</label>
                    <input type="number" className="form-control" id="level" name="level" min="1" max="99" value={props.data.level} onChange={props.handler}></input>
                </div>
            </div>
            ...
            <div className="form-row">
                <div className="form-group col-md-6">
                    ...
                    <input type="number" className="form-control" name="gold" id="gold" min="0" value={props.data.gold} onChange={props.handler}></input>
                </div>

                <div className="form-group col-md-6">
                    <label htmlFor="stashed">Stashed Gold</label>
                    <input type="number" className="form-control" name="stashGold" id="stashed" min="0" max="2500000" value={props.data.stashGold} onChange={props.handler}></input>
                </div>
            </div>

            <p>Attribute points available: {props.stats - props.data.attr.reduce((accum, curr) => accum + curr)}</p>
            ...
            <div className="form-row">
                {baseAttr.map((attr, i) =>
                    <div key={i} className="form-group col-md-3">
                        ...
                        <input type="number" className="attr form-control" name={stat2[i]} id={stat2[i]} min="0" value={props.data.attr[0] + attr} onChange={props.handler}></input>
